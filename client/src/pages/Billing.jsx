      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-800 mb-4">
            Choose the Right Plan for Your Events
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            From intimate webinars to large-scale virtual conferences, we have
        ...
        <div className="max-w-3xl mx-auto mt-20">
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer:
                  "We accept all major credit cards (Visa, Mastercard, American Express) as well as PayPal and bank transfers for Enterprise customers.",
              },
              {
                id: "faq3",
                question: "Do you offer refunds?",
                answer:
                  "We offer a 14-day money-back guarantee for all new customers. If you're not satisfied with our service within the first 14 days, we'll issue a full refund.",
              },
              {
                id: "faq4",
                question: "What happens when I reach my attendee limit?",
                answer:
                  "When you approach your attendee limit, we'll notify you with options to upgrade your plan. If you exceed your limit during an event, we won't cut off access, but you'll need to upgrade before hosting your next event.",
              },
            ].map((faq) => (
              <div
                key={faq.id}
          ...
          <div className="text-center mt-8">
            ...
            <button className="text-blue-600 font-medium hover:text-blue-800 mt-2">
